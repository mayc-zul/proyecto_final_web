            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="editarT.php" name="edit_product">
                        ...
                        <div class="card-deck pb-4">
                            ...
                            <?php for($i=0; $i < count($resultado); $i++): ?>
                                ...
                                <div class="card card-producto">
                                    <a href="vistaproducto.php?categoria=<?php echo 'televisores'?>&id=<?php echo $resultado[$i]['id']?>"><img  class="card-img-top border-bottom" src="data:image/jpg;base64,<?php echo base64_encode(($resultado[$i]['imagen'])); ?>"></a>
                                    <div class="card-body">
