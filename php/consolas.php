            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="editarCon.php" name="edit_product">
                            ...
                            <?php for($i=0; $i < count($resultado); $i++): ?>
                                ...
                                <div class="card card-producto">
                                    ...
                                    <div class="card-footer">
                                        <a href="consolas.php?id=<?php echo $resultado[$i]['id']?>"><i class="fas fa-pencil-alt" style="float: left;"></i></a><a href="eliminarC.php?id=<?php echo $resultado[$i]['id']?>"><i class="far fa-trash-alt" style="float: right;"></i></a>
                                    </div>
                                </div>
                                <?php
